...
function LevelScene:getBlockType(letter, blockX)
    ...
    elseif letter == 'f' then return Turret(blockX, height1, true)
    elseif letter == 'g' then return Turret(blockX, height2, false)
    elseif letter == 'h' then return Turret(blockX, height2, true)
    elseif letter == 'i' then return Turret(blockX, height3, false)
